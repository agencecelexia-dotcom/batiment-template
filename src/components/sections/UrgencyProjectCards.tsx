            ...
            <div className="group rounded-2xl border border-neutral-200 overflow-hidden transition-all duration-300 hover:border-primary-300 hover:shadow-[var(--shadow-card-hover)] hover:-translate-y-1">
              <div className="overflow-hidden">
                <div className="group-hover:scale-105 transition-transform duration-500">
                  <ImagePlaceholder
                    prompt="Chantier de maconnerie avec fissure mur, intervention urgente, photo realiste, ratio 4:3"
                    src={sectionImages["urgence-card"] || undefined}
                    aspectRatio="4/3"
                    alt="Urgence batiment"
                    overlay
          ...
          <FadeIn direction="right" delay={0.2}>
            <div className="group rounded-2xl border border-neutral-200 overflow-hidden transition-all duration-300 hover:border-primary-300 hover:shadow-[var(--shadow-card-hover)] hover:-translate-y-1">
              <div className="overflow-hidden">
                <div className="group-hover:scale-105 transition-transform duration-500">
                  <ImagePlaceholder
                    prompt="Belle maison avec extension moderne, facade renovee, amenagement paysager soigne, photo realiste, ratio 4:3"
