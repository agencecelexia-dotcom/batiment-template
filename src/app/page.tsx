...
export const metadata: Metadata = generatePageMetadata({
  title: `Entreprise de bâtiment à ${siteConfig.address.city} | Devis Gratuit`,
  description: `${siteConfig.name}, entreprise de bâtiment à ${siteConfig.address.city}. Maçonnerie, ravalement, extension, rénovation, aménagement extérieur. Devis gratuit.`,
  path: "/",
});
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        imagePlaceholder={{
          prompt:
            "Artisan macon professionnel francais posant des briques sur un chantier, eclairage naturel, photo realiste, ratio 16:9",
          aspectRatio: "16/9",
