...
import { avisClients } from "@/config/content";

export const metadata: Metadata = generatePageMetadata({
  title: `Avis clients entreprise bâtiment ${siteConfig.address.city}`,
  description: `Découvrez les avis de nos clients. Note ${siteConfig.googleRating}/5 sur ${siteConfig.googleReviewCount} avis Google. Entreprise de bâtiment de confiance à ${siteConfig.address.city}.`,
  path: "/avis-clients",
});
  ...
  return (
    <>
      <HeroSection
        ...
        imagePlaceholder={{
          prompt: "Equipe d'artisans du batiment souriant devant un chantier termine, maison renovee en arriere-plan, lumiere naturelle, photo realiste, ratio 21:9",
          aspectRatio: "21/9",
