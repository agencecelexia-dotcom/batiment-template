  ...
  return (
    <>
      <HeroSection
        ...
        imagePlaceholder={{
          prompt: "Vue aerienne plongee d'un chantier de construction maison individuelle, murs en parpaing, fondations, grue, artisans au travail, lumiere naturelle, photo realiste, ratio 21:9",
          aspectRatio: "21/9",
