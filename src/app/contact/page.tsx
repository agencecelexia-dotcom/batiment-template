...
export const metadata: Metadata = generatePageMetadata({
  title: `Contact entreprise bâtiment ${siteConfig.address.city} | Devis gratuit`,
  ...
  return (
    <>
      <HeroSection
        ...
        imagePlaceholder={{
          prompt: "Bureau d'entreprise de batiment, plans de construction sur table, artisan en discussion avec client, ambiance professionnelle et chaleureuse, photo realiste, ratio 21:9",
          aspectRatio: "21/9",
