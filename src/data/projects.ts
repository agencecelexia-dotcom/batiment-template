...
export const projects: AdminProject[] = [
  ...
  },
  {
    ...
    fullDescription: "Rénovation intégrale d'un appartement de 65m² : démolition de cloisons, création d'un espace ouvert cuisine-salon, plâtrerie, carrelage et peinture.",
    location: "{VILLE}",
    year: 2024,
    featuredImage: "",
    beforeImage: "",
